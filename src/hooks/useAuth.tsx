  ...
  async function signIn() {
    try {
      ...
      if (
        ...
        setUser({
          id: userReponse.data.data[0].id,
          display_name: userReponse.data.data[0].display_name,
          email: userReponse.data.data[0].email,
          profile_image_url: userReponse.data.data[0].profile_image_url,
        });
